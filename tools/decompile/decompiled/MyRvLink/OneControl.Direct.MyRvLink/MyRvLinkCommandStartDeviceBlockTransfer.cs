...
internal class MyRvLinkCommandStartDeviceBlockTransfer : MyRvLinkCommand
{
	...
	protected virtual string LogTag
	{
		[CompilerGenerated]
		get;
	} = "MyRvLinkCommandStartDeviceBlockTransfer";
	...
	public override MyRvLinkCommandType CommandType
	{
		[CompilerGenerated]
		get;
	} = MyRvLinkCommandType.StartDeviceBlockTransfer;
	...
	public MyRvLinkCommandStartDeviceBlockTransfer(ushort clientCommandId, byte deviceTableId, byte deviceId, BlockTransferBlockId blockId, BlockTransferStartOptions options, uint? startAddress, uint? size)
	{
		...
		{
			ArrayExtension.SetValueUInt32(_rawData, startAddress.Value, 8, (Endian)0);
		}
		if (size.HasValue)
		{
			ArrayExtension.SetValueUInt32(_rawData, size.Value, 12, (Endian)0);
		}
		ValidateCommand(_rawData, clientCommandId);
	}

	protected MyRvLinkCommandStartDeviceBlockTransfer(global::System.Collections.Generic.IReadOnlyList<byte> rawData)
	{
	...
	public static MyRvLinkCommandStartDeviceBlockTransfer Decode(global::System.Collections.Generic.IReadOnlyList<byte> rawData)
	{
	...
	protected static uint DecodeStartAddress(global::System.Collections.Generic.IReadOnlyList<byte> decodeBuffer)
	{
		return ArrayExtension.GetValueUInt32(decodeBuffer, 8, (Endian)0);
	}

	protected static uint DecodeSize(global::System.Collections.Generic.IReadOnlyList<byte> decodeBuffer)
	{
		return ArrayExtension.GetValueUInt32(decodeBuffer, 12, (Endian)0);
	}
	...
	public virtual string ToString()
	{
		...
		return $"{LogTag}[Client Command Id: 0x{ClientCommandId:X2}, Table Id: 0x{DeviceTableId:X2}, DeviceId: 0x{DeviceId:X2}, Block Id: {BlockId} Options: {Options} StartAddress: 0x{StartAddress:X} Size: {Size} Raw Data: {ArrayExtension.DebugDump(_rawData, " ", false)}";
	}
}
