...
public class MyRvLinkCommandSetDevicePidWithAddressResponseCompleted : MyRvLinkCommandResponseSuccess
{
	...
	public MyRvLinkCommandSetDevicePidWithAddressResponseCompleted(global::System.Collections.Generic.IReadOnlyList<byte> rawData)
		: base(rawData)
	{
	}
	...
	{
		return $"Command(0x{base.ClientCommandId:X4}) Response {"MyRvLinkCommandSetDevicePidWithAddressResponseCompleted"} PID Value: 0x{PidValue:X}";
	}
}
