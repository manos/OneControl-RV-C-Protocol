...
public class MyRvLinkCommandLeveler1ButtonCommand : MyRvLinkCommand
{
	...
	protected virtual string LogTag
	{
		[CompilerGenerated]
		get;
	} = "MyRvLinkCommandLeveler1ButtonCommand";
	...
	public override MyRvLinkCommandType CommandType
	{
		[CompilerGenerated]
		get;
	} = MyRvLinkCommandType.Leveler1ButtonCommand;
	...
	protected MyRvLinkCommandLeveler1ButtonCommand(global::System.Collections.Generic.IReadOnlyList<byte> rawData)
	{
	...
	public static MyRvLinkCommandLeveler1ButtonCommand Decode(global::System.Collections.Generic.IReadOnlyList<byte> rawData)
	{
	...
	{
		return $"{LogTag}[Client Command Id: 0x{ClientCommandId:X2}, Table Id: 0x{DeviceTableId:X2}, DeviceId: 0x{DeviceId:X2}, Button State Data: 0x{ButtonStateData1:X2} 0x{ButtonStateData2:X2} Raw Data: {ArrayExtension.DebugDump(_rawData, " ", false)} ";
	}
}
