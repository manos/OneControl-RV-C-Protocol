...
public static class ArrayExtension
{
	...
	public static string DebugDump(this byte[] array, string separator = " ", bool binary = false)
	{
		if (binary)
		{
			return string.Join(separator, Enumerable.Select<byte, string>((global::System.Collections.Generic.IEnumerable<byte>)array, (Func<byte, string>)((byte x) => Convert.ToString(x, 2).PadLeft(8, '0'))));
		}
		return BitConverter.ToString(array).Replace("-", separator);
	}

	public static string DebugDump(this global::System.Collections.Generic.IReadOnlyList<byte> array, int startIndex, int length, string separator = " ", bool binary = false)
	{
		if (binary)
		{
			return string.Join(separator, Enumerable.Select<byte, string>(Enumerable.Where<byte>((global::System.Collections.Generic.IEnumerable<byte>)array, (Func<byte, int, bool>)((byte x, int index) => index >= startIndex && index < length)), (Func<byte, string>)((byte x) => Convert.ToString(x, 2).PadLeft(8, '0'))));
		}
		return string.Join(separator, Enumerable.Select<byte, string>(Enumerable.Where<byte>((global::System.Collections.Generic.IEnumerable<byte>)array, (Func<byte, int, bool>)((byte x, int index) => index >= startIndex && index < length)), (Func<byte, string>)((byte x) => Convert.ToString(x, 16).PadLeft(2, '0'))));
	}
	...
	public static void ResizeIfMoreSpaceNeeded(ref byte[] buffer, int absoluteBitPositionStart, int numBits, int bufferByteOffsetStart = 0)
	{
		...
		{
			global::System.Array.Resize<byte>(ref buffer, minimumBytesNeededToCopyBitsToArray);
		}
	}
	...
	public static byte CopyBitsFromArray(this byte[] buffer, int absoluteBitPositionStart, int numBits, int bufferByteOffsetStart = 0)
	{
		...
		byte b = (byte)(num5 >> 8);
		byte b2 = (byte)(num5 & 0xFF);
		ushort num6 = (ushort)((buffer[bufferByteOffsetStart + num2] & b) << 8);
		if (b2 != 0)
		{
			num6 |= (ushort)(buffer[bufferByteOffsetStart + num2 + 1] & b2);
		}
	...
	public static ushort GetValueUInt16(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
	...
	public static ushort GetValueUInt16(this byte[] buffer, int startOffset, Endian endian = Endian.Big)
	{
		...
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 2)).GetValueUInt16(0, endian);
	}
	...
	public static void SetValueUInt16(this byte[] buffer, ushort value, int startOffset, Endian endian = Endian.Big)
	{
		...
		case Endian.Big:
			...
			buffer[1 + startOffset] = (byte)(0xFF & value);
			break;
		case Endian.Little:
	...
	public static short GetValueInt16(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
		//IL_0031: Unknown result type (might be due to invalid IL or missing references)
		byte b;
		byte b2;
	...
	{
		//IL_0003: Unknown result type (might be due to invalid IL or missing references)
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 2)).GetValueInt16(0, endian);
	}
	...
	public static uint GetValueUInt32(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
	...
	{
		//IL_0003: Unknown result type (might be due to invalid IL or missing references)
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 4)).GetValueUInt32(0, endian);
	}
	...
	public static void SetValueUInt32(this byte[] buffer, uint value, int startOffset, Endian endian = Endian.Big)
	{
		...
		case Endian.Big:
			...
			buffer[3 + startOffset] = (byte)(0xFF & value);
			break;
		case Endian.Little:
	...
	public static int GetValueInt32(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
		//IL_0059: Unknown result type (might be due to invalid IL or missing references)
		byte b;
		byte b2;
	...
	{
		//IL_0003: Unknown result type (might be due to invalid IL or missing references)
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 4)).GetValueInt32(0, endian);
	}
	...
	public static void SetValueUInt24(this byte[] buffer, uint value, int startOffset, Endian endian = Endian.Big)
	{
		...
		case Endian.Big:
			...
			buffer[1 + startOffset] = (byte)((0xFF00 & value) >> 8);
			buffer[2 + startOffset] = (byte)(0xFF & value);
			break;
		case Endian.Little:
			buffer[2 + startOffset] = (byte)((0xFF0000 & value) >> 16);
			buffer[1 + startOffset] = (byte)((0xFF00 & value) >> 8);
	...
	public static ulong GetValueUInt48(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
	...
	{
		//IL_0003: Unknown result type (might be due to invalid IL or missing references)
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 6)).GetValueUInt48(0, endian);
	}
	...
	public static ulong GetValueUInt64(this global::System.Collections.Generic.IReadOnlyList<byte> buffer, int startOffset, Endian endian = Endian.Big)
	{
		//IL_005f: Unknown result type (might be due to invalid IL or missing references)
		int num = 8;
		ulong num2 = 0uL;
	...
	{
		//IL_0003: Unknown result type (might be due to invalid IL or missing references)
		return ((global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(buffer, startOffset, 8)).GetValueUInt48(0, endian);
	}
	...
	public static int SetValueBigEndianRemoveLeadingZeros(this byte[] buffer, ulong value, int startOffset, int numBytes)
	{
		...
		if (numBytes == 0)
		{
			throw new ArgumentOutOfRangeException("numBytes", (object)numBytes, "must be less greater then 0");
		}
		if (numBytes > 8)
		{
			throw new ArgumentOutOfRangeException("numBytes", (object)numBytes, $"must be less then or equal to {8}");
		}
		if (numBytes > buffer.Length)
		{
			throw new ArgumentOutOfRangeException("numBytes", (object)numBytes, $"must be less then or equal to the given buffer length of {buffer.Length}");
		}
	...
	public static Guid ToGuid(this byte[] values, int startOffset, Endian endian = Endian.Big)
	{
		...
		num += 4;
		short num2 = (short)values.GetValueUInt16(num, endian);
		num += 2;
		short num3 = (short)values.GetValueUInt16(num, endian);
		num += 2;
		...
		return new Guid(valueUInt, num2, num3, array);
	}
