...
public static class TaggedLog
{
	...
	public static ILogger Tag(string tag)
	{
		...
		if (_taggedLoggerCache.TryGetValue(tag, ref result))
		{
			return result;
		}
		result = defaultLogger.ForContext("SourceContext", (object)tag, false);
	...
	{
		if (Enumerable.Any<object>((global::System.Collections.Generic.IEnumerable<object>)args))
		{
