...
public abstract class BindableAsyncValue<TValue> : CommonDisposableNotifyPropertyChanged, IBindableAsyncValue<TValue>, INotifyPropertyChanged, ICommonDisposable, global::System.IDisposable where TValue : IEquatable<TValue>
{
	...
	public abstract global::System.Threading.Tasks.Task LoadAsync(CancellationToken cancellationToken);

	public abstract global::System.Threading.Tasks.Task SaveAsync(CancellationToken cancellationToken);
}
