...
public class CobsDecoder : CobsBase
{
	...
	public global::System.Collections.Generic.IReadOnlyList<byte>? TryDecodeByte(byte b)
	{
		try
		{
			return DecodeByte(b);
	...
	public global::System.Collections.Generic.IReadOnlyList<byte>? DecodeByte(byte b)
	{
		...
		if (b == FrameCharacter)
		{
			try
			{
				...
				if (UseCrc)
				{
					...
					if (b3 != b2)
					{
						throw new CobsCrcMismatchException(b3, b2, (global::System.Collections.Generic.IReadOnlyList<byte>)(object)new ArraySegment<byte>(_outputBuffer, 0, _destinationNextByteIndex));
					}
				}
				return (global::System.Collections.Generic.IReadOnlyList<byte>?)(object)new ArraySegment<byte>(_outputBuffer, 0, _destinationNextByteIndex);
			}
			finally
			{
				_codeByte = 0;
